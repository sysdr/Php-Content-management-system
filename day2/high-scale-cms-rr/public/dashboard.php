...
<head>
  ...
  <title>CMS High-Scale Day2 — Dashboard</title>
  <style>
...
<body>
  <header><div class="container"><h1>CMS High-Scale Day2 — Dashboard</h1><p>PHP built-in (8000) vs RoadRunner (8080). Use Operations to update metrics.</p></div></header>
  <div class="container">
    <section>
      <h2>Live metrics</h2>
      <div class="metrics">
    ...
    <section>
      <h2>Operations</h2>
      <p>Day2: RoadRunner supervisor &amp; load patterns. Use these to exercise workers and update metrics.</p>
      <div class="ops-grid">
